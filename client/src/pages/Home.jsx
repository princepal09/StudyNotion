    ...
    <div>
      ...
      >
        <Link className="mt-16" to={"/signup"}>
          ...
          >
            <div
              className="flex flex-row items-center gap-2 rounded-full px-10 py-1.25
          ...
          <div className="flex flex-row gap-14 tracking-wider my-10">
            ...
            <div className="flex flex-col gap-10 items-start w-[40%] ">
              <p className="text-[16px] font-semibold ">
                ...
                be a competitive specialist requires more than thier
