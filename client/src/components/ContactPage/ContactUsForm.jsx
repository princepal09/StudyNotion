...
const ContactUsForm = () => {
  ...
  const submitContactForm = async (data) => {
    ...
    try {
      ...
      toast.error("Error Ocurred while submitting the form");
    } finally {
      setLoading(false);
      ...
      <div className="flex flex-col gap-5 lg:flex-row">
        <div className="flex flex-col gap-2 lg:w-[48%]">
          ...
          <input
            ...
            className="rounded-lg bg-richblack-800 p-3 text-[16px] leading-6 
         text-richblack-5 shadow-[0_1px_0_0] shadow-white/50 
         placeholder:text-richblack-200 focus:outline-none"
