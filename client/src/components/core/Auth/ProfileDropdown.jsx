    ...
    >
      ...
      {open && (
        <div
          ...
          className="absolute top-[118%] md:left-0 left-10  z-1000 divide-y divide-richblack-700 overflow-hidden rounded-md border border-richblack-700 bg-richblack-800"
          ref={ref}
        >
